      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-4 h-16">
            ...
            {/* Desktop Navigation */}
            <div className="hidden lg:flex items-center justify-center flex-1 max-w-2xl gap-8">
              {/* Categories Dropdown */}
              <DropdownMenu>
                <DropdownMenuTrigger className="flex items-center gap-1.5 px-4 py-2.5 text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors focus:outline-none rounded-full border border-gray-200 hover:bg-gray-50">
                ...
                <DropdownMenuContent className="w-64 p-2" align="start">
                  <DropdownMenuItem asChild>
                    <Link
                      to="/courses"
                      className="flex items-center gap-2 w-full cursor-pointer p-2.5 rounded-md font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 mb-2"
                    >
                      <Compass className="w-4 h-4" />
                      Browse All Courses
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuLabel className="text-xs text-gray-400 font-normal uppercase tracking-wider px-2 py-1.5">
                    Top Categories
                  </DropdownMenuLabel>
                  {categories.map((category) => (
                    <Link
                      key={category}
                      to={`/courses?search=${encodeURIComponent(category)}`}
                    >
              ...
              {user ? (
                <div className="flex items-center gap-4">
                  <Link to="/dashboard">
                    <Button
                      variant="ghost"
                      className="px-4 py-2.5 text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors focus:outline-none rounded-full border border-gray-200 hover:bg-gray-50"
                    >
                      My Learning
                    </Button>
                  </Link>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-56 mt-2" align="end">
                      ...
                      <DropdownMenuItem
                        ...
                        className="cursor-pointer gap-2 py-2.5 text-red-600 focus:bg-red-50 focus:text-red-700"
                      >
                ...
                <div className="flex items-center gap-3">
                  <Link to="/login">
                    <Button
                      variant="ghost"
                      className="font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100"
                    >
                      Log in
                    </Button>
                  </Link>
                  ...
                  {user && (
                    <>
                      ...
                      >
                        <Button
                          variant="ghost"
                          className="w-full justify-start text-base font-normal h-11 text-gray-600"
                        >
                  ...
                  <div className="space-y-1">
                    {categories.slice(0, 5).map((cat) => (
                      ...
                      >
                        <Button
                          variant="ghost"
                          className="w-full justify-start text-sm font-normal text-gray-600 h-9"
                        >
                          {cat}
                        </Button>
                      </Link>
              ...
              <div className="p-4 border-t bg-gray-50">
                {user ? (
                  <Button
                    onClick={handleLogout}
                    variant="destructive"
                    className="w-full shadow-none bg-red-100 text-red-600 hover:bg-red-200"
                  >
