            ...
            <form onSubmit={handleSignup} className="space-y-4 sm:space-y-5">
                ...
                >
                    ...
                    >
                        ...
                        <User className={`absolute left-2.5 sm:left-3 top-2.5 sm:top-3 h-4 w-4 sm:h-5 sm:w-5 transition-all duration-200 ${focusedField === 'name' ? 'text-purple-600 scale-110' : 'text-gray-400'}`} />
                        <Input
                            type="text"
