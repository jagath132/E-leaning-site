            ...
            <form onSubmit={handleSignup} className="space-y-5">
                ...
                >
                    ...
                    >
                        ...
                        <User className={`absolute left-3 top-3 h-5 w-5 transition-all duration-300 ${focusedField === 'name' ? 'text-purple-600 scale-110' : 'text-gray-400'}`} />
                        <Input
                            type="text"
                ...
                >
                    <motion.div
                        ...
                        transition={{ duration: 0.2 }}
                    >
                        <div className="absolute inset-0 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 rounded-xl opacity-0 group-focus-within:opacity-20 blur transition-opacity duration-300" />
