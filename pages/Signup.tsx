...
import { Mail, Lock, User, Loader2, Github, Eye, EyeOff, Rocket } from "lucide-react";
...
const Signup: React.FC = () => {
    ...
    return (
        <AuthLayout title="Create Account" subtitle="Start your learning adventure today">
            <form onSubmit={handleSignup} className="space-y-4 sm:space-y-5">
                ...
                >
                    ...
                    >
                        ...
                        <User className={`absolute left-2.5 sm:left-3 top-2.5 sm:top-3 h-4 w-4 sm:h-5 sm:w-5 transition-all duration-200 z-10 ${focusedField === 'name' ? 'text-purple-600 scale-110' : 'text-gray-400'}`} />
                        <Input
                            type="text"
                ...
                >
                    <motion.div
                        ...
                        transition={{ duration: 0.15 }}
                    >
                        <div className="absolute inset-0 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 rounded-xl opacity-0 group-focus-within:opacity-20 blur transition-opacity duration-200" />
