            ...
            <div className="space-y-5">
                {!submitted ? (
                    ...
                    <motion.div
                        ...
                        className="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl shadow-lg"
                    >
                        <motion.div
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                ...
                >
                    <Link
                        to="/login"
                        className="inline-flex items-center text-sm font-medium bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent hover:from-purple-700 hover:to-pink-700 transition-all"
                    >
                        <ArrowLeft className="mr-2 h-4 w-4 text-purple-600" />
                        Back to Sign In
                    </Link>
                </motion.div>
            </div>
